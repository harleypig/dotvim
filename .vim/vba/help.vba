...
" ---------------------------------------------------------------------
let b:loaded_aftersyntaxhelp= "v1e"
...
"  Extra Syntax: {{{1
 ...
 syn match helpSectionTitle		'^\s*\u[A-Z0-9,'() :]\{-}\ze\s*[-:]\%(\s*{{{\d\)\='						contains=helpSecTitleBlank,helpSecTitleGap,helpFold
