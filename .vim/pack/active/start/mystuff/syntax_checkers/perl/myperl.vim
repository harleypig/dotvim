...
"Maintainer:  Alan Young <vim at harleypig dot com>
...
"
"============================================================================
" NOTE: I, Alan, stole this because it didn't quite match what I wanted to do
"       for my own checking. I left most of the defaults in place. I did not
"       want the check to be run twice, and I wanted to add my own list of
"       pragmas to test against.
"============================================================================
"
" Security:
"
...
"
" !!! This variable is not needed.  If you need more paths, edit the
" ~/.vim/tools/efm_perl.pl file.
"
...
function! SyntaxCheckers_perl_myperl_IsAvailable() dict
...
"    silent! call system(syntastic#util#shexpand(g:syntastic_perl_interpreter) . ' -e ' . syntastic#util#shescape('exit(0)'))
    silent! call system('[ -f ' . syntastic#util#shexpand(g:syntastic_perl_interpreter) . ' ] && exit 0')
    return v:shell_error == 0
endfunction

function! SyntaxCheckers_perl_myperl_GetLocList() dict
